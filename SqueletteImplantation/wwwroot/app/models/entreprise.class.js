...
var Entreprise = (function () {
    function Entreprise(id, nomentreprise, lieu, notel, poste, personneresponsable, courrielres, nbreconfirmation, nbrpeutetre, nbreprobablementnon, nbrenon, nbreoui, date) {
        this.id = id;
